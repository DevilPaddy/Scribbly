export const verifyEmailTemplate = (username: string, otp: string) => ({
  subject: "🔐 Verify Your Account – My Notes",
  html: `
  <div style="background-color: #1e1e1e; color: #f0f0f0; font-family: 'Segoe UI', sans-serif; padding: 30px; border-radius: 10px; max-width: 500px; margin: auto; box-shadow: 0 0 10px rgba(0,0,0,0.5);">
    ...
    <p style="font-size: 16px; line-height: 1.5;">Thanks for signing up for <strong>My Notes</strong>! You're one step away from getting started. Please use the code below to verify your email address:</p>
    ...
    <p style="font-size: 14px; color: #94a3b8;">Best regards,<br/><strong>– My Notes Team</strong></p>
  </div>
  `,
});
